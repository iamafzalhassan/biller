...
pw.Widget buildItemsTable(List<InvoiceItem> items, int startIndex) =>
    pw.Table(border: _tableBorder, columnWidths: _columnWidths, children: <pw.TableRow>[_headerRow(), for (int i = 0; i < items.length; i++) _itemRow(startIndex + i, items[i])]);
...
pw.TableRow _itemRow(int number, InvoiceItem item) => pw.TableRow(
  children: <pw.Widget>[
