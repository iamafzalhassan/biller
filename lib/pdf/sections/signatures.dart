...
pw.Widget buildSignatures() => pw.Row(crossAxisAlignment: pw.CrossAxisAlignment.end, mainAxisAlignment: pw.MainAxisAlignment.spaceBetween, children: <pw.Widget>[_signature('CUSTOMER SIGNATURE'), _signature('AUTHORISED SIGNATURE')]);
