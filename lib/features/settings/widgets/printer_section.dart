...
class PrinterSection extends StatelessWidget {
  ...
  Widget _targetTile(PrintTarget target, String title, String subtitle) => RadioListTile<PrintTarget>(
  ...
  List<Widget> _thermalOptions() => <Widget>[
